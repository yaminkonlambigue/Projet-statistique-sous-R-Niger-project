...
```{r Gender recodification_1 Niger_baseline_2018}
...
```{r Gender recodification_2 Niger_ea_2019}
#View labels
...
```{r Gender recodification_3 Niger_ea_2020}
#View labels
...
```{r Gender recodification_4 Niger_ea_2021}
#View labels
...
```{r Gender recodification_5 Niger_pdm_2019}
...
```
```{r Gender recodification_6 Niger_pdm_2020}
...
```{r Gender recodification_7 Niger_pdm_2021}
#View labels
...
```{r Gender recodification_8 Niger_pdm_2022}
#View labels
...
```{r 1_identification of dirty variables}
data <- Niger_pdm_2019
